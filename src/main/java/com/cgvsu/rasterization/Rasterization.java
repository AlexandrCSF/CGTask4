...
public class Rasterization {
    ...
    public static void fillTriangle(
            ...
            Double[][] zBuffer, Camera camera, Vector3d pointIn3d1,  Vector3d pointIn3d2, Vector3d pointIn3d3) {

        List<Vector3d> points = new ArrayList<>(Arrays.asList(p1, p2, p3));

        points.sort(Comparator.comparingDouble(Vector3d::getY));
        double cosLight;
        if (GuiController.renderProperties.get(RenderStyle.Light)) cosLight = Utils.getCosLight(camera, pointIn3d1, pointIn3d2, pointIn3d3);
        else cosLight = 1;
    ...
    public static void fillTriangleWithTexture(
            ...
            Vector3d pointIn3D1, Vector3d pointIn3D2, Vector3d pointIn3D3) {
        ...
        double cosLight;
        if (GuiController.renderProperties.get(RenderStyle.Light))
    ...
    public static void fillTriangleWithTexture(
        ...
        fillTriangleWithTexture(gr, new Vector3d((float) x1, (float) y1, (float) z1), new Vector3d((float) x2, (float) y2, (float) z2),
                ...
                myColor1, myColor2, myColor3, zBuffer, camera, image, texturePoint1, texturePoint2, texturePoint3, pointIn3D1, pointIn3D2, pointIn3D3);
    }
